...
def organizarInfoObservatorio(dictObservatorios, tipoOrden):
    ...
    print("\nORDENAR: ", lstValuesdictObservatorios)  #eliminarLuego
    if checkedOrdenCod:
        for i in range(len(lstValuesdictObservatorios)):
            lstValuesdictObservatorios[i].pop(0)
    
    print("FINALORDEN: ", lstValuesdictObservatorios)  #eliminarLuego
    ...
    print(len(lstValuesdictObservatorios))  #eliminarLuego
...
def ordenarInfoArchivo(dictObservatorios):
    ...
    print("\n", lstValuedictObservatorioOrdenado)
...
def recibirInformacion(rutaCsv, rutaFile):
    ...
    infoClima.close()
    print("LISTA INFO CLIMA", lstInfoClima)
...
def convertirToDict(rutaFile, lstEncabezado, lstInfoClima, lstTemps):
    ...
    print(lstEncabezado)  #eliminarLuego
...
def consultarObs(cod, dictObservatorios):
    ...
    while True:
        ...
        if verificarExisteobservatorio == False:
            ...
            print(verificarExisteobservatorio)  #eliminarLuego
...
def inicializarPrograma(rutaFile, csvObservatorio):
    ...
    print(csvObservatorio, len(csvObservatorio))  #eliminarLuego
